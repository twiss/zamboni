...
FORM_FACTORS = [FORM_MOBILE, FORM_TABLET, FORM_DESKTOP]
FORM_FACTOR_CHOICES = dict((f.id, f) for f in FORM_FACTORS)
FORM_FACTOR_LOOKUP = dict((f.slug, f) for f in FORM_FACTORS)

FREE_FORMS = (
    ('free-mobile', FORM_MOBILE),
    ('free-tablet', FORM_TABLET),
    ('free-desktop', FORM_DESKTOP),
)


PAID_FORMS = (
    ('paid-mobile', FORM_MOBILE),
    ('paid-tablet', FORM_TABLET),
)
